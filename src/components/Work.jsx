                        ...
                        {/* Grid item */}
                        {
                            project.map((item, index) => (
                                ...
                                >
                                    ...
                                    <div className='opacity-0 group-hover:opacity-100  duration-300 delay-100'>
                                        ...
                                        <div className='pt-8 text-center'>
                                            ...
                                            <a href={item.github} target='_blank'>
                                                <button
                                                    className='text-center rounded-lg px-4 py-2 m-3 bg-white
                                                text-gray-700 font-bold group-hover:translate-x-'>
                                                    Code
                                                </button>
                                            </a>
                                            {/* eslint-disabled-next-line */}
                                            <a href={item.live} target='_blank'>
                                                <button
                                                    className='text-center rounded-lg px-4 py-2 m-3
